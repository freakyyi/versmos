...
import { ArrowRight, CheckCircle, Wand2, Layers, Sparkles, Film } from "lucide-react";
...
export default function VFXCompositingPage() {
    ...
    async function fetchVideos() {
      try {
        const { data, error } = await supabase
          ...
          `)
          .eq('youtube_playlists.title', 'VFX & Compositing')
  ...
  const benefits = [
    {
      icon: Wand2,
      title: "Visual Magic",
      description: "Transform ordinary footage into extraordinary visual experiences"
    },
    {
      icon: Layers,
      title: "Seamless Integration",
      description: "Flawless compositing that blends reality with imagination"
    },
    {
      icon: Sparkles,
      title: "Advanced Effects",
      description: "From subtle enhancements to spectacular transformations"
    },
    {
      icon: Film,
      title: "Industry Standards",
      description: "Professional-grade VFX using leading software and techniques"
    }
  ];
          ...
          <div className="container mx-auto px-6 lg:px-12">
            ...
            >
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
                VFX & <span className="text-brand-cyan">Compositing</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8">
                Professional visual effects and compositing services that bring your creative vision to life. 
                From subtle enhancements to mind-blowing transformations.
              </p>
          ...
          <div className="container mx-auto px-6 lg:px-12">
            ...
            >
              <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
                Why Choose Our VFX Services?
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Industry-leading visual effects that enhance your storytelling
              </p>
            </motion.div>
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-6 lg:px-12">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Explore our visual effects work across various projects
              </p>
            </motion.div>
        ...
        <section className="py-20">
          <div className="container mx-auto px-6 lg:px-12">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Comprehensive visual effects solutions for any project
              </p>
            </motion.div>
          ...
          <div className="container mx-auto px-6 lg:px-12 text-center">
            ...
            >
              <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">
                Ready to Add Visual Magic?
              </h2>
              <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
                Let&apos;s create stunning visual effects that elevate your content
              </p>
              <Link
                href="/contact"
